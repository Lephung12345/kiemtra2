    ...
    public function __construct() {
        ...
        if (isset($_SESSION['server'], $_SESSION['username'], $_SESSION['password'], $_SESSION['database'])) {
            ...
            public function getCourses() {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="'. strtolower($row['ImageUrl']) . '" class="card-img-top" alt="' . $row['Title'] . '">
                                <div class="card-body">
            ...
            public function isCourseExists($tittle) {
                ...
                // Nếu có kết quả trả về nghĩa là khóa học đã tồn tại
            ...
            public function addCourse($tittle, $description, $ImgUrl) {
                ...
                // Nếu khóa học chưa tồn tại, thêm vào cơ sở dữ liệu
                $sql = "INSERT INTO course Title, Description, ImageUrl) VALUES (?, ?, ?)";
                $stmt = $this->conn->prepare($sql);
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
            ...
            if (empty($courses)) {
                ...
                // Đường dẫn file
                $file_path = "example/filename.txt"; // Đổi tên file tại đây
